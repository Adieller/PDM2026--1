...
class LoginViewModel (private val repository: UserRepository) : ViewModel(){
    ...
    fun validarLogin(onLoginSuccess: (Int, String) -> Unit) {
        ...
        viewModelScope.launch {
            ...
            if (usuarioEncontrado != null) {
                ...
                if (usuarioEncontrado.password == contrasena) {
                    ...
                    onLoginSuccess(usuarioEncontrado.id, usuarioEncontrado.username)
                } else {
...
class LoginViewModelFactory(private val repository: UserRepository) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(com.example.pruebaproyectov1.viewmodel.LoginViewModel::class.java)) {
